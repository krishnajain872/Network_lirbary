...
## 2. Factory Pattern
**Location**: `network/network_lib.h`, `core/src/protocols/protocol_factory.cpp`
...
## 3. Observer Pattern
**Location**: `network/detail/interfaces.h` (Callbacks)
...
## 4. Strategy Pattern
**Location**: `core/include/network/protocols/protocol_handler.h`
...
**Location**: `core/include/network/core/memory/object_pool.h`
